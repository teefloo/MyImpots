...
function CasesContent() {
    ...
    if (query.trim()) {
        displayedBoxes = searchTaxBoxes(query);
    }

    if (selectedCategory) {
        displayedBoxes = displayedBoxes.filter((b) => b.categoryId === selectedCategory);
    }

    if (selectedForm) {
        displayedBoxes = displayedBoxes.filter((b) => b.formId === selectedForm);
    }
